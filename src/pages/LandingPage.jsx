    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-dark-gray p-8 rounded-lg shadow-2xl w-full max-w-md border border-electric-purple/20">
        ...
        <form onSubmit={handleAuth} className="space-y-4">
          <h2 className="text-2xl font-semibold text-center text-electric-blue mb-4">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-electric-purple to-electric-blue text-white p-3 rounded hover:opacity-90 font-bold"
          >
            {formType === 'login' ? 'Login' : 'Register'}
          </button>
        </form>
        ...
        <div className="relative my-4">
          <div className="absolute inset-0 flex items-center">
            <span className="w-full border-t border-light-gray/30"></span>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="bg-dark-gray px-2 text-light-gray">OR</span>
          </div>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full bg-red-600 text-white p-3 rounded hover:bg-red-700 flex items-center justify-center"
        >
          Login with Google
        </button>
      </div>
